...
export default function ExamCardComponent({examId, bookId, subjectName, examName, grade, onModifyButtonClick}) {
    ...
    const handleModifyClick = () => {
        if (onModifyButtonClick) {
            onModifyButtonClick(examId, bookId);  // 부모 컴포넌트로 examId 전달
        }
    };
