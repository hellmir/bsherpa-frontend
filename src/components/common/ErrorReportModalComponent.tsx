...
import {postRegisterErrorReport} from "../../api/step2Api";
// @ts-ignore
...
const ErrorReportModal: React.FC<ErrorReportModalProps> = ({itemId, isOpen, onClose}) => {
    const [selectedFile, setSelectedFile] = useState<File | null>(null);
    const [errorType, setErrorType] = useState<string>("문제오류");
